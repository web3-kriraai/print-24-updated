...
gcloud run deploy $ServiceName `
    ...
    --update-secrets="MONGO_URI_PRICING=MONGO_URI_PRICING:latest,REDIS_URL=REDIS_URL:latest,JWT_SECRET=JWT_SECRET:latest,CLOUDINARY_CLOUD_NAME=CLOUDINARY_CLOUD_NAME:latest,CLOUDINARY_API_KEY=CLOUDINARY_API_KEY:latest,CLOUDINARY_API_SECRET=CLOUDINARY_API_SECRET:latest,EMAIL_HOST=EMAIL_HOST:latest,EMAIL_PORT=EMAIL_PORT:latest,EMAIL_USER=EMAIL_USER:latest,EMAIL_PASSWORD=EMAIL_PASSWORD:latest,EMAIL_FROM=EMAIL_FROM:latest,GCP_GEOLOCATION_API_KEY=GCP_GEOLOCATION_API_KEY:latest,FRONTEND_URL=FRONTEND_URL:latest,ENCRYPTION_KEY=ENCRYPTION_KEY:latest,EXCHANGE_RATE_API_KEY=EXCHANGE_RATE_API_KEY:latest,ENABLE_RECONCILIATION_CRON=ENABLE_RECONCILIATION_CRON:latest" `
    --project=$ProjectId
