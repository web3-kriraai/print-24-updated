...
import AvailabilitySettingsTab from '../../components/designer/AvailabilitySettingsTab';
...
export default function DesignerDashboard() {
    ...
    // Shared state
    const [activeTab, setActiveTab] = useState<'visual' | 'physical' | 'settings'>('visual');
        ...
        <div className="min-h-screen bg-gray-50 pb-12">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="grid lg:grid-cols-3 gap-6">
                    {/* Main Section (2 cols or full width if settings) */}
                    <div className={`${activeTab === 'settings' ? 'lg:col-span-3' : 'lg:col-span-2'} space-y-6`}>
                        ...
                        <div className="flex bg-gray-100 p-1 rounded-lg">
                            ...
                            <button
                                ...
                                className={`flex-1 py-2.5 text-sm font-medium rounded-md transition-all flex items-center justify-center gap-2 ${activeTab === 'settings' ? 'bg-white shadow-sm text-blue-600' : 'text-gray-500 hover:text-gray-700'
                                    }`}
                            >
                                <Clock size={16} />
                                                    ...
                                                    <div className="grid grid-cols-2 gap-4 mb-4 text-xs text-gray-600">
                                                        ...
                                                        <div className="space-y-1">
                                                            ...
                                                            <p className="line-clamp-2">
                                                                {booking.visitLocation === 'OFFICE' && (booking.visitAddress === 'At Prints24 Office' || !booking.visitAddress)
                                                                    ? (profileForm.address || (user as any)?.address || 'At Prints24 Office')
                                        ...
                                        <CardContent>
                                            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-100">
                                                ...
                                                <p className="text-sm text-gray-700 leading-relaxed font-medium">
                                                    {profileForm.address || (user as any)?.address || 'Address not updated yet. Please update in profile.'}
                                                </p>
                                            </div>
                                        </CardContent>
                                    </Card>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="bg-white border border-gray-100 rounded-xl overflow-hidden shadow-sm">
                                        ...
                                        <div className="p-4 grid grid-cols-2 gap-y-4 gap-x-8">
                                            ...
                                            {/* Render all dynamic attributes (Spot UV, Foil, Cutting, etc.) */}
                                            {selectedBookingForDetails.productSnapshot?.selectedDynamicAttributes &&
                                                Object.entries(selectedBookingForDetails.productSnapshot.selectedDynamicAttributes).map(([attrName, attrValue]: [string, any]) => (
                                                    <div key={attrName} className="space-y-0.5">
                                                        <p className="text-xs text-gray-400">{attrName}</p>
                                                        <p className="text-sm font-medium">
                                                            {Array.isArray(attrValue) ? attrValue.join(', ') : String(attrValue)}
                                                        </p>
                                                    </div>
                                                ))
                                            }
                                            {selectedBookingForDetails.productSnapshot?.totalOrderAmount > 0 && (
                                                <div className="space-y-0.5">
                                                    <p className="text-xs text-gray-400">Order Amount</p>
                                                    <p className="text-sm font-medium text-green-600">₹{selectedBookingForDetails.productSnapshot.totalOrderAmount.toLocaleString()}</p>
                                                </div>
                                            )}
                                            {selectedBookingForDetails.productSnapshot?.specialInstructions && (
                                                <div className="space-y-0.5 col-span-2">
                                                    ...
                                                    <p className="text-sm font-medium text-gray-700">{selectedBookingForDetails.productSnapshot.specialInstructions}</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4 bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
                                        <div className="flex gap-4">
                                            ...
                                            <div className="space-y-0.5">
                                                ...
                                                <p className="font-medium text-gray-900">{new Date(selectedBookingForDetails.visitDate).toLocaleDateString()}</p>
                                            </div>
                                        </div>
                                        <div className="flex gap-4">
                                            ...
                                            <div className="space-y-0.5">
                                                ...
                                                <p className="font-medium text-gray-900">
                                                    {selectedBookingForDetails.visitLocation === 'OFFICE' && (selectedBookingForDetails.visitAddress === 'At Prints24 Office' || !selectedBookingForDetails.visitAddress)
                                                        ? (profileForm.address || (user as any)?.address || 'At Prints24 Office')
                                                        : (selectedBookingForDetails.visitAddress || 'N/A')}
                                                </p>
                                            </div>
                                        </div>
                                        <div className="flex gap-4">
