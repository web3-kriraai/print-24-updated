...
import {
    ...
    MoreVertical, CheckSquare, Square, Loader2, List, Database
} from 'lucide-react';
...
const OrderManagement: React.FC = () => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            // If we are on a page > 1 and it's empty, but there are total orders, go back to page 1
            if (fetchedOrders.length === 0 && data.pagination?.total > 0 && pagination.page > 1) {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-[95%] mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all"
                        >
            ...
            {/* Stats Cards */}
            <div className="max-w-[95%] mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <OrderStats refreshTrigger={statsRefreshKey} />
            </div>
