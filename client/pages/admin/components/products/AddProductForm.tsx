...
const AddProductForm: React.FC<AddProductFormProps> = ({
    ...
    useEffect(() => {
        if (productForm.category && (!categoryChildrenMap[productForm.category] || categoryChildrenMap[productForm.category].length === 0)) {
            // Only fetch if we haven't already trying to load (avoids infinite loops if really no children)
            if (!loadingCategoryChildren[productForm.category]) {
                console.log("Auto-loading children for existing category selection:", productForm.category);
                fetchCategoryChildren(productForm.category);
            }
        }
    }, [productForm.category, categoryChildrenMap, loadingCategoryChildren, fetchCategoryChildren]);
    ...
    useEffect(() => {
        if (productForm.category && (!categoryChildrenMap[productForm.category] || categoryChildrenMap[productForm.category].length === 0)) {
            ...
            if (!loadingCategoryChildren[productForm.category]) {
                console.log("Fetching children for existing category:", productForm.category);
                fetchCategoryChildren(productForm.category);
            }
        }
            ...
            >
                                        ...
                                        <div className="border-r border-slate-100 overflow-y-auto bg-slate-50/20 slim-scrollbar">
                                            ...
                                            <div className="p-2 space-y-1">
                                                {!productForm.category ? (
                                                    ...
                                                    <p className="text-[10px] text-slate-400 font-bold uppercase italic text-center py-8">No subcategories found</p>
                                                ) : (
                                        ...
                                        <div className="overflow-y-auto bg-white slim-scrollbar">
                                            ...
                                            <div className="p-2 space-y-1">
                                                {!productForm.subcategory ? (
                                                    ...
                                                    <p className="text-[10px] text-slate-400 font-bold uppercase italic text-center py-8">No nested items found</p>
                                                ) : (
                                                    (categoryChildrenMap[productForm.category] || [])
                                                        .filter(nested => {
                                                    ...
                                                    onClick={() => {
                                                        setSelectedAttributeTypes([
                                                            ...selectedAttributeTypes,
                                                            {
                                                                ...
                                                                name: at.name, // Local display only
                                                                isEnabled: true,
                        ...
                        {selectedAttributeTypes.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {selectedAttributeTypes.map((sa, index) => {
                                    ...
                                    return (
                                        <div key={sa.attributeTypeId} className="group flex items-center justify-between p-4 bg-white/50 backdrop-blur-sm border border-slate-200/60 rounded-xl hover:shadow-md transition-all">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 bg-sky-50 rounded-xl flex items-center justify-center text-sky-500 shadow-sm border border-sky-100/50 group-hover:scale-110 transition-transform">
                                                    <Sliders size={18} />
                                                </div>
                                                <div>
                                                    <p className="text-sm font-bold text-slate-800">{sa.name || (def ? def.name : "Unknown")}</p>
                ...
                {showCreateAttributeModal && (
                    ...
                    >
                        <div
                            data-modal="true"
                            className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-white/20"
                            onClick={(e) => {
                                e.stopPropagation();
                            }}
                        >
                            ...
                            >
                                ...
                                <div className="border-b border-slate-100 pb-8">
                                    <h3 className="text-sm font-bold text-slate-700 uppercase tracking-wider mb-6">Basic Information</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div>
                                            <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">
                                                Attribute Name * <span className="text-[10px] text-slate-400 font-normal">(Visible to customers)</span>
                                            </label>
                                            <input
                                                id="attribute-name"
                                                name="attributeName"
                                                ...
                                                className={`w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 transition-all outline-none ${attributeFormErrors.attributeName ? 'border-red-300 bg-red-50' : ''}`}
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 transition-all outline-none"
                                                required
                                            >
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-col gap-4">
                                                <input
                                                    ...
                                                    className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-500 file:mr-4 file:py-1 file:px-3 file:rounded-full file:border-0 file:text-[10px] file:font-bold file:bg-sky-50 file:text-sky-600 hover:file:bg-sky-100 transition-all cursor-pointer"
                                                />
                                                    ...
                                                    <div className="flex items-center gap-4 p-3 bg-white border border-slate-100 rounded-xl">
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <p className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">
                                                                {(attributeTypeForm.attributeImage.size / 1024).toFixed(2)} KB
                                                            </p>
                                                        </div>
                                                        <button
                                                            type="button"
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 transition-all outline-none"
                                            rows={2}
                                            placeholder="e.g., Changes the product price based on selection"
                                            required
                                        />
                                        <p className="mt-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-relaxed">Describe how this attribute affects the product or customer experience</p>
                                    </div>
                                    ...
                                    <div className="mt-8 border-t border-slate-100 pt-8">
                                        <div className="flex items-center gap-3 mb-6">
                                            ...
                                            <div>
                                                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-widest">Cascading Attributes</h3>
                                                <p className="text-[10px] font-medium text-slate-400">Make this attribute appear based on another selection.</p>
                                            </div>
                                        </div>
                                                ...
                                                return (
                                                    <>
                                                        <div className="space-y-4">
                                                            ...
                                                            <div className="grid grid-cols-1 gap-2 max-h-48 overflow-y-auto border border-slate-200/60 rounded-2xl p-4 bg-slate-50/30 backdrop-blur-sm">
                                                                {parentValues.length === 0 ? (
                                                                    ...
                                                                    parentValues.map((val, idx) => (
                                                                        <label key={idx} className="group flex items-center gap-3 p-2 rounded-xl hover:bg-white transition-all cursor-pointer">
                                                                            <div className="relative flex items-center">
                                                                                <input
                                                                                    ...
                                                                                    className="w-4 h-4 border-slate-300 text-sky-500 rounded focus:ring-sky-500/20"
                                                                                />
                                                                            </div>
                                                                            <span className="text-xs font-medium text-slate-700">{val.label || val.value}</span>
                                                                        </label>
                                                                    ))
                                                                )}
                                                            </div>
                                                                        ...
                                                                        <label key={idx} className="group flex items-center gap-3 p-2 rounded-xl hover:bg-white transition-all cursor-pointer">
                                                                            <div className="relative flex items-center">
                                                                                <input
                                                                                    ...
                                                                                    className="w-4 h-4 border-slate-300 text-red-500 rounded focus:ring-red-500/20"
                                                                                />
                                                                            </div>
                                                                            <span className="text-xs font-medium text-slate-700">{val.label || val.value}</span>
                                                                        </label>
                                ...
                                <div className="mt-8 border-t border-slate-100 pt-8" data-attribute-options-table>
                                    <div className="flex items-center justify-between mb-6">
                                    ...
                                    <div className="border border-slate-200/60 rounded-2xl overflow-hidden bg-white/50 backdrop-blur-sm shadow-sm">
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider px-2">Attribute Settings</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {/* Allow Filtering */}
                                        <div className="flex items-center gap-4 p-4 bg-white/60 border border-slate-200/60 rounded-2xl hover:border-sky-300 transition-all group">
                                            <div className="p-2.5 bg-sky-50 rounded-xl text-sky-600 group-hover:scale-110 transition-transform">
                                                <Filter size={18} />
                                            </div>
                                            <div className="flex-1">
                                                <h4 className="text-xs font-bold text-slate-800">Allow Filtering</h4>
                                                <p className="text-[10px] text-slate-500">Enable in sidebar filters.</p>
                                            </div>
                                            <input
                                                type="checkbox"
                                        ...
                                        <div className="flex items-center gap-4 p-4 bg-white/60 border border-slate-200/60 rounded-2xl hover:border-sky-300 transition-all group">
                                            ...
                                            <div className="flex-1">
                                                <h4 className="text-xs font-bold text-slate-800">Required Selection</h4>
                                                <p className="text-[10px] text-slate-500">Must be chosen to order.</p>
                                            </div>
                                            <input
                                                type="checkbox"
                                        ...
                                        <div className="flex items-center gap-4 p-4 bg-white/60 border border-slate-200/60 rounded-2xl hover:border-sky-300 transition-all group">
                                            ...
                                            <div className="flex-1">
                                                <h4 className="text-xs font-bold text-slate-800">Global Attribute</h4>
                                                <p className="text-[10px] text-slate-500">Available across all categories.</p>
                                            </div>
                                            <input
                                                type="checkbox"
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-slate-100">
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="flex-1 px-8 py-4 bg-sky-500 text-white text-xs font-bold uppercase tracking-widest rounded-2xl hover:bg-sky-600 shadow-lg shadow-sky-100 transition-all disabled:opacity-50"
                                    >
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => setShowCreateAttributeModal(false)}
                                        className="flex-1 px-8 py-4 bg-slate-100 text-slate-600 text-xs font-bold uppercase tracking-widest rounded-2xl hover:bg-slate-200 transition-all"
                                    >
                                        Cancel
                                    </button>
                                </div>
