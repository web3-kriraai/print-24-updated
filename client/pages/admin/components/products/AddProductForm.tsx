            ...
            >
                ...
                <div className="border border-slate-200/60 rounded-xl p-6 bg-white/70 backdrop-blur-md shadow-sm">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                        ...
                        <button
                            type="button"
                            onClick={() => {
                                // Redirect to attribute types tab
                                updateUrl("attribute-types");
                            }}
                                            ...
                                            <div className="flex items-center gap-2">
                                                <button
                                                    ...
                                                    onClick={async () => {
                                                        ...
                                                        // Redirect handled by AdminDashboard
                                                    }}
                ...
                {showCreateAttributeModal && (
                    ...
                    >
                        <div
                            data-modal="true"
                            className="bg-white rounded-[2rem] p-0 max-w-4xl w-full max-h-[90vh] shadow-2xl border border-white/20 flex flex-col overflow-hidden"
                            onClick={(e) => {
                                e.stopPropagation();
                            }}
                        >
                            <div className="flex-none flex items-center justify-between p-8 pb-6 border-b border-slate-100 bg-white">
                                <h3 className="text-xl font-bold text-slate-800 flex items-center gap-4">
                                    <div className="w-12 h-12 bg-sky-50 rounded-2xl flex items-center justify-center text-sky-500 shadow-sm border border-sky-100/50">
                                        {editingAttributeTypeId ? <Edit size={22} /> : <Plus size={22} />}
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-lg font-bold text-slate-800">{editingAttributeTypeId ? 'Edit Attribute Type' : 'Create New Attribute Type'}</span>
                                        <span className="text-xs font-medium text-slate-400">Configure attribute settings and options</span>
                                    </div>
                                </h3>
                                <button
                                    type="button"
                                    ...
                                    >
                                        ...
                                        <div className="bg-slate-50/50 border border-slate-100 rounded-2xl p-6">
                                            <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider mb-6 flex items-center gap-2">
                                                <div className="w-6 h-6 bg-slate-200 rounded-full flex items-center justify-center text-slate-600 text-[10px]">1</div>
                                                Basic Information
                                            </h3>

                                            {/* Row 1: Names & Input Style */}
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            ...
                                                            if (attributeFormErrors.attributeName) setAttributeFormErrors({ ...attributeFormErrors, attributeName: undefined });
                                                        }}
                                                        className={`w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 transition-all outline-none font-medium text-slate-700 ${attributeFormErrors.attributeName ? 'border-red-300 bg-red-50' : ''}`}
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 transition-all outline-none font-medium text-slate-700"
                                                ...
                                                <div>
                                                    ...
                                                    <div className="relative">
                                                        <select
                                                            ...
                                                            className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 transition-all outline-none font-medium text-slate-700 appearance-none"
                                                            required
                                                        >
                                                            <option value="DROPDOWN">Dropdown Menu</option>
                                                            <option value="POPUP">Pop-Up Selection</option>
                                            ...
                                            {/* Row 2: Function, Effect, Order, Default */}
                                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                                                <div>
                                                    ...
                                                    <div className="relative">
                                                        <select
                                                            value={attributeTypeForm.functionType}
                                                            onChange={(e) => setAttributeTypeForm({ ...attributeTypeForm, functionType: e.target.value })}
                                                            className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 transition-all outline-none font-medium text-slate-700 appearance-none"
                                                        >
                                                ...
                                                <div>
                                                    ...
                                                    <div className="relative">
                                                        <select
                                                            value={attributeTypeForm.primaryEffectType}
                                                            onChange={(e) => setAttributeTypeForm({ ...attributeTypeForm, primaryEffectType: e.target.value })}
                                                            className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 transition-all outline-none font-medium text-slate-700 appearance-none"
                                                        >
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        type="number"
                                                        value={attributeTypeForm.displayOrder}
                                                        onChange={(e) => setAttributeTypeForm({ ...attributeTypeForm, displayOrder: parseInt(e.target.value) || 0 })}
                                                        className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 transition-all outline-none font-medium text-slate-700"
                                                    />
                                                </div>
                                                <div>
                                                    ...
                                                    <input
                                                        type="text"
                                                        value={attributeTypeForm.defaultValue}
                                                        onChange={(e) => setAttributeTypeForm({ ...attributeTypeForm, defaultValue: e.target.value })}
                                                        className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 transition-all outline-none font-medium text-slate-700"
                                            ...
                                            {/* Row 3: Settings Checkboxes */}
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                                                <label className="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-200 cursor-pointer hover:bg-sky-50/50 hover:border-sky-200 transition-all">
                                                    <input
                                                        type="checkbox"
                                                        checked={attributeTypeForm.isRequired}
                                                        onChange={(e) => setAttributeTypeForm({ ...attributeTypeForm, isRequired: e.target.checked })}
                                                        className="w-4 h-4 text-sky-500 border-slate-300 rounded focus:ring-sky-500/20"
                                                    />
                                                ...
                                                <label className="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-200 cursor-pointer hover:bg-sky-50/50 hover:border-sky-200 transition-all">
                                                    <input
                                                        type="checkbox"
                                                        checked={attributeTypeForm.isPricingAttribute}
                                                        onChange={(e) => setAttributeTypeForm({ ...attributeTypeForm, isPricingAttribute: e.target.checked })}
                                                        className="w-4 h-4 text-sky-500 border-slate-300 rounded focus:ring-sky-500/20"
                                                    />
                                                    <span className="text-xs font-bold text-slate-600 uppercase">Pricing Attr.</span>
                                                </label>
                                                <label className="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-200 cursor-pointer hover:bg-sky-50/50 hover:border-sky-200 transition-all">
                                                    <input
                                                        type="checkbox"
                                                        ...
                                                        className="w-4 h-4 text-sky-500 border-slate-300 rounded focus:ring-sky-500/20"
                                                    />
                                                    <span className="text-xs font-bold text-slate-600 uppercase">Filterable</span>
                                                </label>
                                                <label className="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-200 cursor-pointer hover:bg-sky-50/50 hover:border-sky-200 transition-all">
                                                    <input
                                                        type="checkbox"
                                                        ...
                                                        className="w-4 h-4 text-sky-500 border-slate-300 rounded focus:ring-sky-500/20"
                                                    />
                                                    <span className="text-xs font-bold text-slate-600 uppercase">Common</span>
                                                </label>
                                            </div>
                                                    ...
                                                    <div className="flex flex-col gap-4">
                                                        <input
                                                            ...
                                                            onChange={(e) => {
                                                                ...
                                                                if (file) setAttributeTypeForm({ ...attributeTypeForm, attributeImage: file });
                                                            }}
                                                            className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-xs text-slate-500 file:mr-4 file:py-1 file:px-3 file:rounded-full file:border-0 file:text-[10px] file:font-bold file:bg-sky-50 file:text-sky-600 hover:file:bg-sky-100 transition-all cursor-pointer"
                                                        />
                                                        {attributeTypeForm.attributeImage && (
                                                            <div className="flex items-center gap-4 p-3 bg-white border border-slate-100 rounded-xl shadow-sm">
                                                                ...
                                                                <div className="flex-1">
                                                                    <p className="text-[10px] font-bold text-slate-800 truncate max-w-[150px]">
                                                                        {attributeTypeForm.attributeImage.name}
                                                                    </p>
                                                                </div>
                                                                <button
                                                                    type="button"
                                                                    onClick={() => setAttributeTypeForm({ ...attributeTypeForm, attributeImage: null })}
                                                                    className="text-red-400 hover:text-red-500 p-2 hover:bg-red-50 rounded-lg transition-all"
                                                                >
                                                                    <Trash2 size={16} />
                                                                </button>
                                                            </div>
                                        ...
                                        {/* Step 2: Cascading Attributes Card */}
                                        <div className="bg-slate-50/50 border border-slate-100 rounded-2xl p-6">
                                            <div className="flex items-center gap-3 mb-6">
                                                ...
                                                <div>
                                                    <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider">Cascading Rules</h3>
                                                    <p className="text-[10px] font-medium text-slate-400">Configure conditional visibility based on other attributes.</p>
                                                </div>
                                            </div>
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <SearchableDropdown
                                                        ...
                                                        options={[
                                                            ...
                                                            ...attributeTypes
                                                                .filter(attr => !attr.parentAttribute)
                                                                .map((attr) => ({
                                                                    value: attr._id,
                                                ...
                                                {attributeTypeForm.parentAttribute && (() => {
                                                    ...
                                                    return (
                                                        <>
                                                            <div className="space-y-4">
                                                                <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider">
                                                                    Show When Parent Value Is
                                                                </label>
                                                                <div className="grid grid-cols-1 gap-2 max-h-48 overflow-y-auto border border-slate-200 rounded-xl p-4 bg-white/50 custom-scrollbar">
                                                                    {parentValues.length === 0 ? (
                                                                        <p className="text-[10px] text-slate-400 font-bold uppercase italic text-center py-4">No values defined</p>
                                                                    ) : (
                                                                        parentValues.map((val, idx) => (
                                                                            <label key={idx} className={`group flex items-center justify-between p-3 rounded-lg border transition-all cursor-pointer ${attributeTypeForm.showWhenParentValue.includes(val.value) ? 'bg-sky-50 border-sky-200 shadow-sm' : 'bg-white border-transparent hover:bg-slate-50'}`}>
                                                                                <span className={`text-xs font-medium ${attributeTypeForm.showWhenParentValue.includes(val.value) ? 'text-sky-700' : 'text-slate-600'}`}>{val.label || val.value}</span>
                                                                                <div className="relative flex items-center">
                                                                                    <input
                                                                                        ...
                                                                                        className={`w-4 h-4 rounded focus:ring-sky-500/20 ${attributeTypeForm.showWhenParentValue.includes(val.value) ? 'text-sky-500 border-sky-500' : 'border-slate-300 text-slate-300'}`}
                                                                                    />
                                                                                </div>
                                                                            </label>
                                                                        ))
                                                            ...
                                                            <div className="space-y-4">
                                                                ...
                                                                <div className="grid grid-cols-1 gap-2 max-h-48 overflow-y-auto border border-slate-200 rounded-xl p-4 bg-white/50 custom-scrollbar">
                                                                    {parentValues.length === 0 ? (
                                                                        ...
                                                                        parentValues.map((val, idx) => (
                                                                            <label key={idx} className={`group flex items-center justify-between p-3 rounded-lg border transition-all cursor-pointer ${attributeTypeForm.hideWhenParentValue.includes(val.value) ? 'bg-red-50 border-red-200 shadow-sm' : 'bg-white border-transparent hover:bg-slate-50'}`}>
                                                                                <span className={`text-xs font-medium ${attributeTypeForm.hideWhenParentValue.includes(val.value) ? 'text-red-700' : 'text-slate-600'}`}>{val.label || val.value}</span>
                                                                                <div className="relative flex items-center">
                                                                                    <input
                                                                                        type="checkbox"
                                                                                        ...
                                                                                        className={`w-4 h-4 rounded focus:ring-red-500/20 ${attributeTypeForm.hideWhenParentValue.includes(val.value) ? 'text-red-500 border-red-500' : 'border-slate-300 text-slate-300'}`}
                                                                                    />
                                                                                </div>
                                                                            </label>
                                                                        ))
                                        ...
                                        {/* Step 3: Options Card */}
                                        <div className="bg-slate-50/50 border border-slate-100 rounded-2xl p-6" data-attribute-options-table>
                                            <div className="flex items-center justify-between mb-6">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[10px] font-medium text-slate-400">Define the specific values for this attribute.</p>
                                                    </div>
                                                </div>
                                                <button
                                                    type="button"
                                                    ...
                                                    className="px-4 py-2 text-xs bg-sky-500 text-white font-bold uppercase tracking-widest rounded-xl hover:bg-sky-600 shadow-lg shadow-sky-100 transition-all flex items-center gap-2"
                                                >
                                                    <Plus size={14} />
                                                    Add Option
                                                </button>
                                            ...
                                            <div className="border border-slate-200 rounded-xl overflow-hidden bg-white shadow-sm">
                                                {attributeTypeForm.attributeOptionsTable.length === 0 ? (
                                                    <div className="p-10 text-center bg-slate-50/50">
                                                        <p className="text-slate-400 text-xs font-medium italic">No options added. Click "Add Option" to start.</p>
                                                    </div>
                                                ) : (
                                                                    ...
                                                                    <tr key={index} className="group hover:bg-slate-50/50 transition-colors">
                                                                        <td className="px-6 py-4">
                                                                            <input
                                                                                ...
                                                                                className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 outline-none transition-all"
                                                                                placeholder="e.g., Glossy"
                                                                                required
                                                                            />
                                                                        </td>
                                                                                    ...
                                                                                    <input
                                                                                        ...
                                                                                        onChange={(e) => {
                                                                                            ...
                                                                                            if (!e.target.checked && !updated[index].optionUsage.image && !updated[index].optionUsage.listing) {
                                                                                                setError("At least one usage required");
                                                                                                return;
                                                                                            }
                                                                                            setAttributeTypeForm({ ...attributeTypeForm, attributeOptionsTable: updated });
                                                                                            setError(null);
                                                                                        ...
                                                                                        className="w-4 h-4 text-sky-500 border-slate-300 rounded focus:ring-sky-500/20"
                                                                                    />
                                                                                    <span className="text-[10px] font-bold text-slate-600 uppercase group-hover/label:text-sky-500 transition-colors">Price</span>
                                                                                </label>
                                                                                <label className="flex items-center gap-2 cursor-pointer group/label">
                                                                                    <input
                                                                                        type="checkbox"
                                                                                        ...
                                                                                        className="w-4 h-4 text-sky-500 border-slate-300 rounded focus:ring-sky-500/20"
                                                                                    />
                                                                                    <span className="text-[10px] font-bold text-slate-600 uppercase group-hover/label:text-sky-500 transition-colors">Image</span>
                                                                                </label>
                                                                                <label className="flex items-center gap-2 cursor-pointer group/label">
                                                                                    <input
                                                                                        type="checkbox"
                                                                                        ...
                                                                                        className="w-4 h-4 text-sky-500 border-slate-300 rounded focus:ring-sky-500/20"
                                                                                    />
                                                                                    <span className="text-[10px] font-bold text-slate-600 uppercase group-hover/label:text-sky-500 transition-colors">Listing</span>
                                                                                </label>
                                                                            </div>
                                                                        </td>
                                                                        {attributeTypeForm.attributeOptionsTable.some(opt => opt.optionUsage?.price) && (
                                                                                ...
                                                                                {option.optionUsage?.price ? (
                                                                                    <div className="flex items-center gap-2">
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            className="w-24 px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 outline-none transition-all"
                                                                                            placeholder="0.00"
                                                                                            step="0.01"
                                                                                            min="0"
                                                                                        />
                                                                                    ...
                                                                                    <span className="px-2 py-1 bg-slate-100/50 text-slate-400 text-[10px] font-bold rounded-md uppercase">N/A</span>
                                                                                )}
                                                                            </td>
                                                                        )}
                                                                        {attributeTypeForm.attributeOptionsTable.some(opt => opt.optionUsage?.image) && (
                                                                            <td className="px-6 py-4">
                                                                                {option.optionUsage?.image ? (
                                                                                    <input
                                                                                        ...
                                                                                        className="w-20 px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 outline-none transition-all"
                                                                                        placeholder="0"
                                                                                        min="0"
                                                                                    />
                                                                                ) : (
                                                                            ...
                                                                            <td className="px-6 py-4">
                                                                                {option.optionUsage?.listing ? (
                                                                                    <input
                                                                                        ...
                                                                                        className="w-full min-w-[150px] px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 outline-none transition-all"
                                                                        ...
                                                                        <td className="px-6 py-4">
                                                                            <div className="flex flex-col gap-2">
                                                                                <input
                                                                                    ...
                                                                                    className="w-full text-[10px] text-slate-500 file:mr-2 file:py-1 file:px-2 file:rounded-md file:border-0 file:text-[9px] file:font-bold file:bg-sky-50 file:text-sky-600 hover:file:bg-sky-100 transition-all cursor-pointer"
                                                                                />
                                                                                {option.image && (
                                                                                    <div className="w-10 h-10 rounded-lg border border-slate-200 overflow-hidden bg-slate-50 shadow-sm">
                                        ...
                                        <div className="border-t border-slate-100 pt-8 mt-4">
                                            <h3 className="text-sm font-bold text-slate-700 uppercase tracking-wider mb-6">Additional Settings</h3>
                                            <div className="space-y-4">
                                                {/* Is Price Effect Checkbox */}
                                                <div className="group/item flex items-start gap-4 p-5 bg-slate-50/50 backdrop-blur-sm rounded-2xl border border-slate-200/60 hover:bg-slate-50/80 transition-all duration-300">
                                                    <div className="p-2.5 bg-sky-50 rounded-xl text-sky-600 group-hover/item:bg-sky-100 group-hover/item:scale-110 transition-all duration-300">
                                                        <CreditCard size={20} />
                                                    </div>
                                                    <div className="flex-1 space-y-3">
                                                        <div className="flex items-center justify-between">
                                                            <div>
                                                                <h4 className="text-sm font-semibold text-slate-800">Is Price Effect?</h4>
                                                                <p className="text-[11px] text-slate-500">Enable if selecting this attribute modifies the total cost.</p>
                                                            </div>
                                                            <input
                                                                type="checkbox"
                                                                checked={attributeTypeForm.isPriceEffect}
                                                                onChange={(e) => setAttributeTypeForm({ ...attributeTypeForm, isPriceEffect: e.target.checked })}
                                                                className="w-5 h-5 text-sky-500 border-slate-300 rounded-lg focus:ring-sky-500/20 transition-all"
                                                            />
                                                        </div>
                                                        {attributeTypeForm.isPriceEffect && (
                                                            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="pt-3 border-t border-slate-200/60 space-y-2">
                                                                <label className="block text-xs font-bold text-slate-600 uppercase tracking-wider">Price Effect Amount (₹ per 1000 units) *</label>
                                                                <div className="flex items-center gap-3">
                                                                    <div className="relative flex-1">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            className="w-full pl-8 pr-4 py-2 bg-white border border-slate-200 rounded-xl text-sm focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 outline-none transition-all"
                                                                            placeholder="e.g., 20"
                                                                            step="0.00001"
                                                                            min="0"
                                                                    ...
                                                                    <span className="text-[11px] font-medium text-slate-500 bg-slate-100 px-3 py-1.5 rounded-lg whitespace-nowrap">per 1000 units</span>
                                                                </div>
                                                            </motion.div>
                                                        )}
                                                    </div>
                                                ...
                                                <div className="group/item flex items-start gap-4 p-5 bg-slate-50/50 backdrop-blur-sm rounded-2xl border border-slate-200/60 hover:bg-slate-50/80 transition-all duration-300">
                                                    ...
                                                    <div className="flex-1 space-y-3">
                                                        <div className="flex items-center justify-between">
                                                            <div>
                                                                <h4 className="text-sm font-semibold text-slate-800">Is Step Quantity?</h4>
                                                                <p className="text-[11px] text-slate-500">Restrict quantity to preset steps (e.g. 1000, 2000, 3000).</p>
                                                            </div>
                                                            <input
                                                                type="checkbox"
                                                        ...
                                                        {attributeTypeForm.isStepQuantity && (
                                                            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="pt-3 border-t border-slate-200/60 space-y-4">
                                                                <div className="flex items-center justify-between">
                                                                    <h5 className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Configure Steps</h5>
                                                                    <button
                                                                        type="button"
                                                                        onClick={() => setAttributeTypeForm({ ...attributeTypeForm, stepQuantities: [...attributeTypeForm.stepQuantities, { quantity: "", price: "" }] })}
                                                                        className="px-3 py-1.5 text-[10px] font-bold bg-sky-500 text-white rounded-lg hover:bg-sky-600 shadow-sm shadow-sky-200 transition-all flex items-center gap-1.5 uppercase"
                                                                    >
                                                                        <Plus size={12} strokeWidth={3} /> Add Step
                                                                    </button>
                                                                </div>
                                                                {attributeTypeForm.stepQuantities.length === 0 ? (
                                                                    <div className="py-4 text-center border-2 border-dashed border-slate-200 rounded-xl">
                                                                        <p className="text-xs text-slate-400">No steps defined. Click "Add Step" to begin.</p>
                                                                    </div>
                                                                ) : (
                                                                    <div className="space-y-2">
                                                                        {attributeTypeForm.stepQuantities.map((step, index) => (
                                                                            <div key={index} className="flex items-center gap-3 p-3 bg-white border border-slate-200 rounded-xl shadow-sm hover:border-sky-300 transition-all">
                                                                                <div className="flex items-center gap-4 flex-1">
                                                                                    <div className="space-y-1 flex-1">
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            className="w-full px-2 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-xs outline-none focus:border-sky-400 transition-all"
                                                                                            placeholder="Qty"
                                                                                        />
                                                                                    </div>
                                                                                    <div className="space-y-1 flex-1">
                                                ...
                                                <div className="group/item flex items-start gap-4 p-5 bg-slate-50/50 backdrop-blur-sm rounded-2xl border border-slate-200/60 hover:bg-slate-50/80 transition-all duration-300">
                                                    ...
                                                    <div className="flex-1 space-y-3">
                                                        <div className="flex items-center justify-between">
                                                            <div>
                                                                <h4 className="text-sm font-semibold text-slate-800">Is Range Quantity?</h4>
                                                                <p className="text-[11px] text-slate-500">Enable if selecting this attribute allows quantity ranges.</p>
                                                            </div>
                                                            <input
                                                                type="checkbox"
                                                        ...
                                                        {attributeTypeForm.isRangeQuantity && (
                                                            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="pt-3 border-t border-slate-200/60 space-y-4">
                                                                <div className="flex items-center justify-between">
                                                                    <h5 className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Configure Ranges</h5>
                                                                    <button
                                                                        type="button"
                                                                        onClick={() => setAttributeTypeForm({ ...attributeTypeForm, rangeQuantities: [...attributeTypeForm.rangeQuantities, { min: "", max: "", price: "" }] })}
                                                                        className="px-3 py-1.5 text-[10px] font-bold bg-sky-500 text-white rounded-lg hover:bg-sky-600 shadow-sm shadow-sky-200 transition-all flex items-center gap-1.5 uppercase"
                                                                    >
                                                                        <Plus size={12} strokeWidth={3} /> Add Range
                                                                    </button>
                                                                </div>
                                                                {attributeTypeForm.rangeQuantities.length === 0 ? (
                                                                    <div className="py-4 text-center border-2 border-dashed border-slate-200 rounded-xl">
                                                                        <p className="text-xs text-slate-400">No ranges defined. Click "Add Range" to begin.</p>
                                                                    </div>
                                                                ) : (
                                                                    <div className="space-y-2">
                                        ...
                                        {attributeTypeForm.primaryEffectType === "FILE" && (
                                            <div className="p-6 bg-slate-50/50 backdrop-blur-sm rounded-2xl border border-slate-200/60 transition-all duration-300">
                                                <div className="flex items-center gap-3 mb-4">
                                                    <div className="p-2 bg-sky-50 rounded-xl text-sky-600">
                                                        <FileText size={18} />
                                                    </div>
                                                    <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider">File Requirements</h3>
                                                </div>
                                                <div className="space-y-3">
                                                    ...
                                                    <textarea
                                                        ...
                                                        className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm focus:ring-4 focus:ring-sky-500/10 focus:border-sky-400 outline-none transition-all placeholder:text-slate-300"
                                                        rows={3}
                                                        placeholder="e.g., Upload your design file (JPG, PNG, PDF). Minimum 300 DPI recommended."
                                                    />
                                                    <p className="text-[10px] text-slate-500 italic">
                                                        Specify allowed formats, minimum resolution, or any other necessary print specifications.
                                                    </p>
                                                </div>
                                            </div>
                                        )}
                            ...
                            <div className="flex-none p-6 border-t border-slate-100 bg-white z-10">
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <button
                                        type="submit"
                                        form="attribute-form"
                                        disabled={loading}
                                        className="flex-1 px-8 py-4 bg-sky-500 text-white text-xs font-bold uppercase tracking-widest rounded-2xl hover:bg-sky-600 shadow-lg shadow-sky-100 transition-all disabled:opacity-50 active:scale-[0.98]"
                                    >
                                        {loading ? "Processing..." : (editingAttributeTypeId ? "Update Attribute" : "Create Attribute")}
                                    </button>
                                    <button
                                        type="button"
                                        onClick={() => {
                                        ...
                                        className="flex-1 px-8 py-4 bg-slate-50 text-slate-600 text-xs font-bold uppercase tracking-widest rounded-2xl hover:bg-slate-100 transition-all border border-slate-200"
                                    >
                                        Cancel
                                    </button>
                                </div>
