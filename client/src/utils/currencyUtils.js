 ...
 */
export const formatPrice = (amount, currencyCode = 'INR', options = {}) => {
    const {
        decimals = 2,
        showSymbol = true,
        locale = 'en-US'
 ...
 * @param {object} pricing - Pricing object from API
 * @param {string} field - Field to format (totalPayable, subtotal, etc.)
 * @returns {string} Formatted price
 */
export const formatPricingField = (pricing, field = 'totalPayable') => {
