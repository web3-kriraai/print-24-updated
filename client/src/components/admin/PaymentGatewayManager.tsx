                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                    <div>
                        <div className="flex items-center space-x-3 mb-2">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900">Payment Gateway Manager</h1>
                                <p className="text-gray-600">Configure, monitor, and manage all payment gateways in one place</p>
                            </div>
                        </div>
                    </div>
