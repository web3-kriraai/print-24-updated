...
// ADD THIS FUNCTION COMPONENT INSIDE OrderDetails.tsx (before main component or as a separate component)
...
/*
 * USAGE:
 * Inside your OrderDetails JSX, add this button in the actions section (e.g., near Download Invoice button):
 * 
 * {order && (
 *   <ComplaintButton 
 *     orderId={order._id} 
