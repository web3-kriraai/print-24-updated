...
const Navbar: React.FC = () => {
  ...
  const getInitials = (name: string) => {
    // Safety check for undefined/null/empty name
                ...
                {!userData || !isMounted ? (
                  ...
                  <div className="relative profile-dropdown">
                    ...
                    >
                      ...
                      >
                        {getInitials(userData.name || userData.email?.split('@')[0] || 'User')}
                      </div>
                      <span className="text-cream-700 text-sm font-medium">
                        {(userData.name || userData.email?.split('@')[0] || 'User').split(" ")[0]}
                      </span>
                    </button>
                  ...
                  {!userData || !isMounted ? (
                    <>
                      <button
                        ...
                        className="w-full text-center text-cream-900 font-medium text-base py-3"
                      >
                        Login
                      </button>
                      <button
                        ...
                        className="w-full bg-cream-900 text-cream-50 py-3 rounded-lg font-medium text-base"
                      >
                        Sign Up
                      </button>
                    </>
