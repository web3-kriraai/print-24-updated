    ...
    async initializeTransaction(params) {
        try {
            ...
            const paymentParams = {
                ...
                surl: `${process.env.BASE_URL || `http://localhost:${process.env.PORT || 5000}`}/api/payment/callback/payu`,
                furl: `${process.env.BASE_URL || `http://localhost:${process.env.PORT || 5000}`}/api/payment/callback/payu`,
                // Optional fields
