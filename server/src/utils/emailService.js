  ...
  try {
    ...
    const mailOptions = {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <a href="${process.env.FRONTEND_URL || 'https://kelsi-kimonoed-corene.ngrok-free.dev'}/login" class="button">Login to Your Account</a>
              <div class="footer">
      ...
      text: `
        ...
        Login URL: ${process.env.FRONTEND_URL || 'https://kelsi-kimonoed-corene.ngrok-free.dev'}/login
  ...
  try {
    ...
    const mailOptions = {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <a href="${process.env.FRONTEND_URL || 'https://kelsi-kimonoed-corene.ngrok-free.dev'}/profile" class="button">View My Orders</a>
              <div class="footer">
      ...
      text: `
        ...
        View Orders: ${process.env.FRONTEND_URL || 'https://kelsi-kimonoed-corene.ngrok-free.dev'}/profile
